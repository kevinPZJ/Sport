...
import com.ykrank.utils.SystemCompact;

import java.lang.reflect.Field;
import java.lang.reflect.Method;

/**
 * Fork from https://github.com/laobie
 */
public class StatusBarUtil {
    ...
    private static boolean useKitkatApi() {
        return isEmui3_1() || (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT && Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP);
    }

    private static boolean useLollipopApi() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && !isEmui3_1();
    }

    public static boolean isEmui3_1() {
        if (SystemCompact.isEMUI()){
            int code = SystemCompact.getEMUICode();
            if (code == 8){
                return true;
            }
        }
